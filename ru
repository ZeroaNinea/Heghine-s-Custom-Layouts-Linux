...
xkb_symbols "typewriter" {
    ...
    key <AC06>	{[       Cyrillic_er,       Cyrillic_ER,    U20BD  ]}; // Ruble sign: ₽
};
...
xkb_symbols "sah" {
    ...
    key <AB07> { [  Cyrillic_softsign, Cyrillic_SOFTSIGN, Cyrillic_shha,      Cyrillic_SHHA        ] };
...
xkb_symbols "phonetic_azerty" {
    ...
    key <AE12>	{[    Cyrillic_che,    Cyrillic_CHE,      braceright,   dead_ogonek ]};
...
// яЯ чЧцЦ сС мМ иИйЙ тТ ьЬъЪ ,< .> /?
    ...
    key <AD01>	{[ Cyrillic_ha,   Cyrillic_HA  ]};
